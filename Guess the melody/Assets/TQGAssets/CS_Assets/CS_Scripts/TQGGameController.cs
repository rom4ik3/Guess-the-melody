...
namespace TriviaQuizGame
{
...

    {
        ...
        // The width of a single life in the lives bar. This is calculated from the total width of a life ar divided by the number of lives
            ...
            if (gameOverCanvas)
            {
                ...
                if (players[currentPlayer].score > highScore)
                {
                  ...
                  //  PlayerPrefs.SetFloat("high", highScore);
                    ...
                    {
                        PlayerPrefs.SetFloat("highnormal", highScore);
                    }
                    else if (SceneManager.GetActiveScene().name == "reverse")
                    {
                        PlayerPrefs.SetFloat("highreverse", highScore);
                    }
